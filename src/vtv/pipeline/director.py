...
class RuleBasedVisualDirector:
    ...
    async def direct(
        ...
        *,
        ...
        # Grounding is deliberately NOT performed here. It is enforced for every
        # director by `vtv.pipeline.plan_gate.PlanGate`, because a safety
        # property each implementation must remember to invoke is a convention,
        # not a guarantee (see that module, and docs/GROUNDING.md).
        plans = [
            self.plan_scene(
                scene,
                understanding,
