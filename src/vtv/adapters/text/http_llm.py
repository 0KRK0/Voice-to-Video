...
Written against the widely-implemented "OpenAI-compatible chat completions"
contract, which most hosted and self-hosted model servers accept unchanged.
        ...
        try:
            async with httpx.AsyncClient(timeout=self.timeout_seconds) as client:
                response = await client.post(
                    resolve_endpoint(self.endpoint, "/chat/completions"),
                    headers={
