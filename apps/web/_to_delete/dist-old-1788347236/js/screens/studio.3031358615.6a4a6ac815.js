 ...
 */
import { announce, el, fill, on } from "/js/core/dom.b9f550b45c.b9f550b45c.js";
import { attempt, present } from "/js/core/errors.c2fe9c6c98.fc533d1d4b.js";
import { clamp, clock, humanise, plural, quantise } from "/js/core/format.9733f01a54.9733f01a54.js";
import { Disposer } from "/js/core/store.898a47de9e.898a47de9e.js";
import { openDialog, refuseAt, toast } from "/js/widgets/dialog.e684c71873.cd02d66442.js";
import { skeleton } from "/js/widgets/states.acb58b27e1.10c6714e62.js";
import { ProjectEventStream } from "/js/api/events.bc66ab1644.bc66ab1644.js";
import { createStudioState, loadStudio, resolveSelection, } from "/js/studio/state.9cbd9f6cab.4aac393990.js";
import { createScriptPanel } from "/js/studio/script-panel.7c75775f00.ac426f5166.js";
import { createPreview } from "/js/studio/preview.9a960aed23.bed96184f2.js";
import { createInspector } from "/js/studio/inspector.57ea23f5ac.4d8415be62.js";
import { createTimeline } from "/js/studio/timeline.edd6869fd9.eac61d2d45.js";
import { assetDetail, createMediaPanel } from "/js/studio/media-panel.ae49a82cfc.0e56b288c5.js";
import { chooseRevision, decideOverrun, disclosuresBeforeExport, groundingRefused, recordingDiverged, reviewRevision, } from "/js/studio/decisions.7f2d061ae8.d33c66a352.js";
import { UndoStack, invert } from "/js/studio/undo.12900ea204.12900ea204.js";
import { SHORTCUTS, installShortcuts } from "/js/studio/shortcuts.58d3c8356f.d0b1d105e3.js";
import { buildingPanel } from "/js/screens/record.d3ee419947.01455472dd.js";
import { createTopbar } from "/js/studio/topbar.d6dddd23de.2f248b6fc6.js";
import { installPanes } from "/js/studio/panes.0c1157faa9.b19715167a.js";
...
export function studioScreen(root, projectId, query, deps) {
    ...
    const topbar = createTopbar({
        ...
        onBudget: (usd) => void setBudget(usd),
        onStyle: () => 
    ...
    /** Set what this project may spend, and say what that buys. */
    async function setBudget(usd) {
        const projectId = state.projectId;
        if (!projectId)
            return;
        try {
            await client.setProjectBudget(projectId, usd);
        }
        catch (error) {
            const shown = present(error);
            toast(shown.message, { tone: shown.tone });
