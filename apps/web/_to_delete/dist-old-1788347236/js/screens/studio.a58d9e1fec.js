...
import { attempt, present } from "/js/core/errors.e9b5ae7cee.js";
...
import { openDialog, refuseAt, toast } from "/js/widgets/dialog.d062b393a9.js";
...
import { createPreview } from "/js/studio/preview.df86e8f05c.js";
import { createInspector } from "/js/studio/inspector.b3b3217685.js";
import { createTimeline } from "/js/studio/timeline.edd6869fd9.js";
import { assetDetail, createMediaPanel } from "/js/studio/media-panel.71d713aaa6.js";
import { chooseRevision, decideOverrun, disclosuresBeforeExport, groundingRefused, recordingDiverged, reviewRevision, } from "/js/studio/decisions.c687ac6640.js";
...
import { buildingPanel } from "/js/screens/record.3ed6e5da6a.js";
import { createTopbar } from "/js/studio/topbar.b96d50f98d.js";
...
export function studioScreen(root, projectId, query, deps) {
    ...
    async function startRender(scope) {
        ...
        const key = body.scope === "range"
            ? `render:${version}:${body.start}-${body.end}`
            : `render:${version}:full`;
