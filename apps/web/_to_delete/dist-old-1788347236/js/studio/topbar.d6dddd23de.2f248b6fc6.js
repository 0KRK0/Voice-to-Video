 ...
 */
import { el, fill, on } from "/js/core/dom.b9f550b45c.b9f550b45c.js";
import { clock, humanise } from "/js/core/format.9733f01a54.9733f01a54.js";
...
export function createTopbar(deps) {
    ...
    budget.value.replaceChildren(el("span", { class: "muted" }, "$"), budgetInput, budgetNote);
    ...
    const node = el("header", { class: "topbar" }, el("button", {
        ...
        onclick: () => deps.onBack(),
    }, "‹"), title, saved, el("div", { class: "spacer" }), el("div", { class: "topbar__facts" }, mode.node, style.node, aspect.node, language.node, pacing.node, target.node, budget.node), busy, el("div", { class: "topbar__actions" }, undoButton, redoButton, el("button", { class: "btn", type: "button", onclick: () => deps.onExport() }, "Export"), renderButton));
