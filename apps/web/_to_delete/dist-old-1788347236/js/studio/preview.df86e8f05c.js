...
import { clamp, timecode } from "/js/core/format.9733f01a54.js";
import { Disposer, debounce } from "/js/core/store.898a47de9e.js";
/**
...
export function createPreview(deps) {
    ...
    function applyAspectRatio() {
        placeholder.style.aspectRatio = parseAspectRatio(state.project.get()?.aspect_ratio);
    }
    /**
