...
class Authorizer:
    ...
    #: Organisations known to be suspended, refreshed by the caller. Checked
    #: before capabilities: a suspended tenant's admin is still an admin, and
    #: still must not be able to spend money.
    ...
    def check(
        ...
        *,
        ...
        if organisation_id is not None and organisation_id in self.suspended:
