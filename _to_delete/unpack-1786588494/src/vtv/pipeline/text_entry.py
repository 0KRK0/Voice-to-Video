...
def transcript_from_text(
    text: str, *, project_id: str, language: str = "en"
) -> Transcript:
...
async def visualise_text(
    ...
    *,
    ...
    project = Project(style=style, persistence=PersistenceMode.TEMPORARY)

    transcript = transcript_from_text(content, project_id=project.project_id)
