...
class Theme:
    ...
    def font(self, role: str) -> ImageFont.FreeTypeFont:
        sizes = {
        ...
        return load_font(weights.get(role, "regular"), sizes.get(role, self.scale(0.03)))
    ...
    @classmethod
    def from_style(
        cls, style: StyleProfile, *, width: int, height: int
    ) -> Theme:
