...
class VisualDirector(Protocol):
    ...
    async def direct(
        self, *, scene_graph: SceneGraph, understanding: Understanding
    ) -> VisualPlan: ...
...
class RuleBasedVisualDirector:
    ...
    async def direct(
        ...
        plans = [
            self.plan_scene(scene, understanding, scene_graph.style)
    ...
    def plan_scene(
        self, scene: Scene, understanding: Understanding, style: StyleProfile
    ) -> SceneVisualPlan:
        units = [
            unit
        ...
        primary = self._primary(scene, units, entities, quantities, style, understanding)
